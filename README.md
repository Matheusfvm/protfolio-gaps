<h1>Portfólio das APIs - Matheus Fernando Vieira de Melo</h1>
...
<p align= "center">• <a href="https://www.linkedin.com/in/matheusfvmelo/">LinkedIn</a> • <a href="https://github.com/Matheusfvm">GitHub</a> •</p>
<hr>
<h2>Meus Projetos</h2>
...
<br>
<span id="contribuicoesPessoais1"></span>
<h3>Contribuições Pessoais</h3>
<p>Esse projeto atuei como desenvolvedor mais voltado para o banco de dados</p>
<ul>
  ...
  <li>Criação do modelo físico</li>
  <p>Responsável por transcrever as entidades do modelo conceitual em scripts sql.</p>
  <li>Atualização do modelo físico e conceitual</li>
  <p>Qualquer atualização que o modelo físico passava era minha responsabilidade transcrever isso para o modelo conceitual e vice-versa.</p>
</ul>
</div>
<br>
...
<br>
<span id="previaSolucao2"></span>
<h3>Prévia da Solução</h3>
<p align= "justify">A partir dos objetivos propostos ao cliente, foi desenvolvida uma aplicação baseada em três frentes (Dados do Relatório deCompra, Recebimento da matéria prima, Relatório Final)
<ul>
  <li>Dados do Relatório de Compra:</li>
  <p align= "justify">Nessa etapa primeiramente era cadastrado um relatório de compras com informações tanto da entrega do grão (frete, data etc.) quanto dos parâmetros para as análises quantitativas (peso) e qualitativa (umidade, pureza, etc). </p>
...
<br>
<span id="previaSolucao3"></span>
<h3>Prévia da Solução</h3>
<p align= "justify">A partir dos objetivos propostos ao cliente, foi desenvolvida uma aplicação baseada em três frentes (CRUD de projeto, tribuição de colaboradores a cada nível do projeto, Acompanhamento de prazos)
<ul>
  <li>CRUD de projeto:</li>
  <p align= "justify">Nessa etapa ocorria o cadastro de projeto que pedia ser realizado de duas maneiras, através da leitura de um arquivo .XLSL ou cadastrado diretamente na aplicação </p>
  <li>Atribuição de colaboradores a cada nível do projeto:</li>
  <p align= "justify">Seguindo a estrutura do projeto cadastro cada nível podia-se atribuir um tipo de colaborador, para atuar como responsável daquele nível e acompanhar as métricas do mesmo.</p>
  <li>Acompanhamento de prazos:</li>
  <p align= "justify">O acompanhamento era realizado através de duas tabelas intituladas "Acompanhamento Planejado" e "Acompanhamento Real".</p>	
</ul>
<span id="aprendizados3"></span>
<h3>Aprendizados</h3>
<p align= "justify">Voltei a atuar com Desenvolvedor. Tive meu primeiro contato com uma linguagem fortemente tipada, com uma ORM (Object-relational mapping) e também a um banco não relacional. </p><br>
<details>
  <summary><h4>Hard Skills</h4></summary>
  <br>
  <table align="center">
...
<br>
<span id="contribuicoesPessoais3"></span>
<h3>Contribuições Pessoais</h3>
